    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                String toSignInEmail = inputEmail.getText().toString().trim();
                final String toSignInPassword = inputPassword.getText().toString().trim();

                if (TextUtils.isEmpty(toSignInEmail)) {
                ...
                auth.signInWithEmailAndPassword(toSignInEmail,toSignInPassword).addOnCompleteListener(SigninActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
